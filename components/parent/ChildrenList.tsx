    ...
    <div className="flex flex-col gap-3">
      {linkedChildren.map((child) => (
        <Link
          ...
          className="flex items-center gap-3 rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 hover:border-zinc-700 hover:bg-zinc-800/50 transition-colors group"
        >
