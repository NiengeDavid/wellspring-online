...
// Query: *[  _type == "quizAttempt"  && quiz._ref == $quizId  && student == $studentId] | order(completedAt desc)[0] {  _id,  scorePercent,  passed,  totalPointsAwarded,  answers[] { questionKey, isCorrect, pointsAwarded }}
